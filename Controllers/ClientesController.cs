...
namespace EnsaioApp.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteName")] Cliente cliente)
        {
            if (!string.IsNullOrEmpty(cliente.ClienteName))
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,ClienteName")] Cliente cliente)
        {
